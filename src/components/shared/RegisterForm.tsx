    ...
    <div className="w-full space-y-6">
      <div className="space-y-2 text-center md:text-left">
        ...
        <p className="text-sm text-slate-500">
          Daftarkan diri Anda untuk menganalisis dan merencanakan masa depan karir yang tepat.
        </p>
      </div>

      {isSuccess && (
        <div className="flex items-start gap-3 rounded-lg border border-teal-200 bg-teal-50 p-4 text-sm text-teal-800 animate-in fade-in slide-in-from-top-2 duration-300">
          <CheckCircle2 className="size-5 shrink-0 text-teal-600" />
          <div>
            <p className="font-semibold">Pendaftaran Berhasil!</p>
            <p className="text-teal-700/90">Akun Anda telah berhasil dibuat. Mengalihkan ke dashboard...</p>
          </div>
        </div>
      )}
