    ...
    <div className="flex min-h-[calc(100vh-73px)] w-full overflow-hidden bg-slate-50">
      ...
      <div className="relative hidden w-1/2 flex-col justify-between bg-indigo-950 p-12 text-white lg:flex">
        ...
        <div className="relative z-10 space-y-6 my-auto max-w-lg">
          <div className="inline-flex items-center gap-1.5 rounded-full bg-[#0f9488]/10 px-3 py-1 text-xs font-semibold text-teal-300 border border-teal-500/20 backdrop-blur-sm">
          ...
          <p className="text-base text-indigo-200/80 leading-relaxed">
            Hanya butuh 1 menit untuk mendaftarkan akun. Mulai jalani tes rekomendasi dan biarkan algoritma pintar kami menganalisis pilihan karir terbaik Anda.
          </p>

          <div className="flex flex-col gap-3 pt-6 border-t border-white/10 text-sm text-indigo-200/90">
            <div className="flex items-center gap-3">
              <div className="flex size-6 items-center justify-center rounded-full bg-teal-500/20 border border-teal-500/30 text-teal-400">
